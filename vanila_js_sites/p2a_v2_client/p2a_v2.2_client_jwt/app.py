...
def api_login():
    ...
    if user and bcrypt.check_password_hash(user.password, password):
        ...
        credentials = {"APP_API_KEY":"dGVuYW50NV9fU0VQUkFUT1JfX3Rlc3RhcHA=",
                   "app_name": "testapp","tenant": "tenant5"}#This all should go in Credentials setup probably!
    
        # if tezkit_token:
        #     # Ensure this is done only once right now you can commit it temp after the first time login.
        #     reqUrl = "https://v1u9b7mohg.execute-api.ap-south-1.amazonaws.com/prod/onboarding"
